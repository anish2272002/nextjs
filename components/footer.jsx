        ...
        <div className="container">
            <div className="row py-4">
                ...
                <div className="col-md-2 p-3">
                    <p style={{fontWeight:400}}>MATERIAL DEPOT</p>
                    <div style={{fontWeight:700}}>FAQs</div>
                    <div style={{fontWeight:700}}>About us</div>
                    <div style={{fontWeight:700}}>Contact Us</div>
                    <div style={{fontWeight:700}}>Careers</div>
                </div>
                <div className="col-md-3 p-3">
                    <p style={{fontWeight:400}}>FOLLOW US</p>
                    <div className="pb-3 d-flex">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="1.8em" viewBox="0 0 496 512">
            ...
            <div className="w-100 p-1 pb-3" style={{fontSize:'0.9em'}}>
                <hr style={{border:'0.8px solid black',opacity:1}}/>
                <span className="">Terms & Conditions &nbsp; Privacy Policy &nbsp; Refund Policy &nbsp; Shipping Policy &nbsp; </span>
                <span className="d-block d-sm-inline" style={{fontWeight:700}}>Powered by All Building Materials Technologies Private Limited</span>
            </div>
        </div>
    );
}
